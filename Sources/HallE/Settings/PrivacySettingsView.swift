    ...
    var body: some View {
        Form {
            Section("Where your data lives") {
                ...
                dataRow("Meeting notes", ObsidianVaultConfig.load()?.rootURL.path ?? "vault not set")
            ...
            Section("Privacy posture") {
                ...
                Label("Deepgram audio processing and OpenClaw/Gemini transcript processing are independently revocable", systemImage: "checkmark.shield")
                ...
                Label("No secret is ever written to notes, logs, or files", systemImage: "key.fill")
            }
